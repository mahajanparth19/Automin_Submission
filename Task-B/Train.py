...
train_labels = pd.read_csv(path + "EN_train_task_b.tsv", sep='\t', header=1)
name_template = train + "task_B_en_train_"
...
dev_labels = pd.read_csv(path + "EN_dev_task_b.tsv", sep='\t', header=1)
name_template = dev + "task_B_en_dev_"
